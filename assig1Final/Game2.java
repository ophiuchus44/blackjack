	...
	//	System.out.println("you made it to playGame");
		...
		for (int i=0; i<rounds; i++){
			...
			if(playerBank<betAmount){
				...
				System.out.println("PLAYER GOES TO ATM AND GETS $" + originalBank + " in round " + i);
				playerBank= playerBank + originalBank;

				//System.out.println("NOW, Current bank amount is $"+  playerBank);
		...
		System.out.println("############## BONUS RESULTS ##############");


		System.out.println("Player BIGBET Blackjack (+/-) " + blackJackBigBet);
		...
		System.out.println("ATM visits " + atmLoss);

		System.out.println("Player Started with $" + originalBank);

		System.out.println("Player currently has $" + playerBank);

		int losses = atmLoss * 500;

		int tmp = playerBank - losses;

		//System.out.println("Player Final Bank = $" + (playerBank-=atmLoss));
		System.out.println("Player's current bank - ATM visits = $" + tmp);

		int profit = tmp - originalBank;

		System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
		System.out.println("$ Player PROFITS are = $" + profit + "      $");
		System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
...
/////// every round should start this way
		...
		double countAmount = theCount/ totalDecks;
